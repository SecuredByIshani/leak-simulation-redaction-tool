...
# --- Added explicit input/output handling ---
options.input_stream = open("tests/test-ssns.pdf", "rb")
options.output_stream = open("redacted.pdf", "wb")

pdf_redactor.redactor(options)
print("✅ Redaction completed successfully! Output: redacted.pdf")
